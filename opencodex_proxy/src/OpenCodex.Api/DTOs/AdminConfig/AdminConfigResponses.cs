...
namespace OpenCodex.Api.DTOs.AdminConfig;
...
public sealed class ConfigResponse
{
    ...
    public static ConfigResponse From(IReadOnlyList<ChannelRecord> channels)
    {
...
public sealed class ChannelResponse
{
    ...
    public static ChannelResponse From(ChannelRecord channel)
    {
...
public sealed class ConfigExportResponse
{
    ...
    public static ConfigExportResponse From(IReadOnlyList<ChannelRecord> channels)
    {
