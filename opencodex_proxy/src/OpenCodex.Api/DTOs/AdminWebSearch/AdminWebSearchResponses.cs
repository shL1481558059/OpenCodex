...
public sealed class WebSearchConfigResponse
{
    ...
    public static WebSearchConfigResponse From(WebSearchConfigRecord config)
    {
...
public sealed class TavilyKeyResponse
{
    ...
    public static TavilyKeyResponse From(TavilyKeyRecord key)
    {
...
public sealed class WebSearchTestKeyResponse
{
    ...
    public static WebSearchTestKeyResponse From(TavilyKeyRecord key)
    {
