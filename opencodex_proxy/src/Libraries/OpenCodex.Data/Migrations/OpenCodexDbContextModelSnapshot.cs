...
{
    [DbContext(typeof(OpenCodexDbContext))]
    partial class OpenCodexDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenCodex.Core.Domain.Channel", b =>
                {
                    ...
                    b.HasKey("OwnerUsername", "Id");

                    b.HasIndex("OwnerUsername", "Position");

                    b.HasIndex("OwnerUsername", "Priority", "Position", "Id");
            ...
            modelBuilder.Entity("OpenCodex.Core.Domain.RequestLog", b =>
                {
                    ...
                    b.Property<long?>("ParentRequestLogId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("OpenCodex.Core.Domain.AccessApiKey", b =>
                {
                    b.HasOne("OpenCodex.Core.Domain.User", "Owner")
                        .WithMany("AccessApiKeys")
            ...
            modelBuilder.Entity("OpenCodex.Core.Domain.RequestLog", b =>
                {
                    b.HasOne("OpenCodex.Core.Domain.RequestLog", "ParentRequestLog")
                        .WithMany("ChildRequestLogs")
                        .HasForeignKey("ParentRequestLogId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("ParentRequestLog");
                });

            modelBuilder.Entity("OpenCodex.Core.Domain.RequestLogDetail", b =>
                {
                    b.HasOne("OpenCodex.Core.Domain.RequestLog", "RequestLog")
                        .WithOne("Detail")
                        .HasForeignKey("OpenCodex.Core.Domain.RequestLogDetail", "RequestLogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OpenCodex.Core.Domain.RequestLog", b =>
                {
                    b.Navigation("ChildRequestLogs");

                    b.Navigation("Detail");

                    b.Navigation("StreamLines");
                });

            modelBuilder.Entity("OpenCodex.Core.Domain.User", b =>
                {
                    b.Navigation("AccessApiKeys");
                });
