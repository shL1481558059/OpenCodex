...
public interface IChannelCircuitBreakerService
{
    ...
    ChannelHealthStatus GetHealthStatus(string ownerUsername, string channelId, bool enabled);
    ...
    bool TryAcquireHalfOpenProbe(string ownerUsername, string channelId);
    ...
    /// <param name="ownerUsername">渠道所属用户名。</param>
    /// <param name="channelId">渠道标识符。</param>
    void ReleaseHalfOpenProbe(string ownerUsername, string channelId);
